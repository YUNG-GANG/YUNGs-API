...
public class PieceInRangeCondition extends StructureCondition {
    ...
    public boolean passes(StructureContext ctx) {
        ...
        if (structureManager == null) YungsApiCommon.LOGGER.error("Missing required field 'structureManager' for piece_in_range condition!");
        ...
        if (structureManager == null || pieces == null || pieceEntry == null) return false;

...
public class EnhancedBeardifierHelper {
     ...
     * @param chunkAccess The ChunkAccess
     * @param original The original vanilla Beardifier.
     */
    public static void forStructuresInChunk(StructureFeatureManager structureManager, ChunkAccess chunkAccess, EnhancedBeardifierData original) {
        ...
        List<StructureStart> structureStarts = structureManager.startsForFeature(SectionPos.bottomOf(chunkAccess), structure -> structure.config instanceof YungJigsawConfig);
        for (StructureStart structureStart : structureStarts) {
            EnhancedTerrainAdaptation structureTerrainAdaptation = ((YungJigsawConfig) structureStart.getFeature().config).getEnhancedTerrainAdaptation();
        ...
        original.setEnhancedRigidIterator(enhancedBeardifierRigidList.iterator());
        original.setEnhancedJunctionIterator(enhancedJunctionList.iterator());
    }

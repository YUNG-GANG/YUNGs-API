...
public class ParticleTypeModuleForge {
    public static void processEntries() {
        YungsApiForge.loadingContextEventBus.addListener(YungsApiForge.buildAutoRegistrar(Registries.PARTICLE_TYPE, AutoRegistrationManager.PARTICLE_TYPES, ParticleTypeModuleForge::buildParticleType));
    }
